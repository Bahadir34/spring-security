...
public class User {
    ...
    @Column(length = 255, nullable = false) // password DB'ye kaydedilmeden önce şifreleneceği
    private String password;

    //role
    @ManyToMany(fetch = FetchType.EAGER) // user'ı tablodan çektiğimiz anda roller gelsin. defaultta lazy'dir.
